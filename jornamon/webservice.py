...
course_ids = sock.execute(database, uid, password, 'jornamon.course', 'search', [('code','=','IC-997')])
# SIn dominio para el filtro
# course_ids = sock.execute(database, uid, password, 'jornamon.course', 'search', [])
print course_ids
courses = sock.execute(database, uid, password, 'jornamon.course', 'read', course_ids, ['code','name'])
print courses
res = sock.execute(database, uid, password, 'jornamon.course', 'check_seats', course_ids)
print res
