...
class Course (osv.Model):
    ...
    _columns = {
        ...
        'session_ids': fields.one2many('diego_dev.course.session','course_id',string='Sessions'),
...
class CourseSession(osv.Model):
    ...
    _columns = {
        ...
        'course_id': fields.many2one('diego_dev.course', string='Course', required=True, select=True, ondelete='cascade', readonly=True, states={'draft': [('readonly',False)]}),
